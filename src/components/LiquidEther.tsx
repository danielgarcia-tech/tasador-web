...
export default function LiquidEther({
  ...
  useEffect(() => {
    console.log('LiquidEther: Initializing component');
    if (!mountRef.current) {
      console.log('LiquidEther: No mount ref');
      return;
    }
...
`;
    ...
    console.log('LiquidEther: Starting WebGL setup');
    ...
    console.log('LiquidEther: WebGL initialized, starting animation');
    ...
    console.log('LiquidEther: Animation started');
  ...
  console.log('LiquidEther: Rendering component');
